		  ...
		  <thead>
			...
			<tr>
				...
				<td>
					<?php
						$picture =  $row['p_image'];
						echo "<img src='prodimg/$picture' width=50 height=40>";
					?>
				</td>
				...
				<td><a href="editItem.php?p_id=<?php echo ($row['p_id']); ?>">Edit</a>&nbsp<a href="deleteItem.php?p_id=<?php echo ($row['p_id']); ?>" onclick="return confirm('SURE?')">Delete</a></td>
			</tr>
			<?php } ?>
		</table>
		<br><br>
        <center>
        <a href="orderList.php"><button class="button button1"name="orderList" type="submit">Order List</button></a>
		<a href="addItem.php"><button class="button button2" name="orderList" type="submit">Add Item</button></a>
        </center>
		 </div>
