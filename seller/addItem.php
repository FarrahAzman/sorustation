			...
			<form method="post" enctype="multipart/form-data">
         	<table align="center">
                   <tr>
						...
						<td align="left">&nbsp<input type="text" name="p_name" required="on"></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						...
						<td align="left">&nbsp<input type="text"  name="p_price" size="50" required="on"></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
                    <tr>
						...
						<select name="p_type" required>
							...
							<option value="Mix Grill">Mix Grill</option>
							<option value="Side&Bites">Side & Bites</option>
					...
					<tr>
						...
						<td align="left"><textarea rows="5" cols="39" name="p_description" required="on"></textarea></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						...
						<td align="left">&nbsp<input type="file" name="logo" size="20" required="on"></td></td>
					</tr>
				</table>
...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		//masukkan dalam table product based on seller id
		$query = mysqli_query($link, "INSERT INTO product(s_id, p_name, p_type, p_brand, p_price, p_quantity_onhand, p_image, p_description)VALUES('$s_id','$p_name','$p_type','$p_brand','$p_price','$p_quantity_onhand', '$newimg1', '$p_description')");
