	...
	<div class="site-content">
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                include_once ('connectionReservation.php');
			   ...
			   ?>
                ...
                <?php if($row['r_status']!='Confirmed' && $row['r_status']!='Pending' ) 
                    { ?>
					<td><a href="uo.php?r_id=<?php echo $row['r_id'] ?>"><button class="button button1">Reservation Confirmed</button></a></td>
                    <?php } ?>
			</tr>
                </tbody>
                <?php } ?>
