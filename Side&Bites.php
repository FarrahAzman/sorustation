<?php 
    ...
    $queryT = mysqli_query($link, "SELECT * FROM product WHERE p_name != '' AND p_type = 'Side&Bites'");
   
    
?>
<!DOCTYPE html>
<html lang="en">
<title>Side&Bites</title>
<head>
    <meta charset="UTF-8">
